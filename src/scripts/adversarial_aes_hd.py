...
from _common import *
from datasets.aes_hd import AES_HD, to_key_preds
...
data_module = datasets.load('aes-hd', train_batch_size=BATCH_SIZE, eval_batch_size=1024, root=ROOT)
...
for norm_penalty in norm_penalties:
    ...
    training_module = AdversarialLocalizationModule(
        ...
        classifier_optimizer_kwargs={'lr': 2e-5},
