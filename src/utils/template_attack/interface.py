...
class TemplateAttack:
    ...
    def attack(self, attack_dataset: Dataset, n_repetitions=100, n_traces=100):
        ...
        rank_over_time = _accumulate_ranks(log_p_x_given_y + self.log_p_y, keys, plaintexts, indices)
