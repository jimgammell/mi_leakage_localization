...
class DataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str):
        self.train_dataset = ED25519(root=self.root, train=True)
        ...
        self.test_dataset = ED25519(self.root, train=False, transform=transform, target_transform=target_transform)
